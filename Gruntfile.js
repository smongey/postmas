    ...
    buildcontrol: {
      dist: {
        options: {
          ...
          remote: 'git@github.com:smongey/postmas.git',
          branch: 'gh-pages'
        }
      }
    },
      ...
      dist: {
        options: {
          patterns: [
            {
              match: /("|'?)\/?styles\//g,
              replacement: '$1http://smongey.github.io/postmas/styles/'
            },
            {
              match: /("|'?)\/?scripts\//g,
              replacement: '$1http://smongey.github.io/postmas/scripts/'
            },
            {
              match: /(<a[^>]*href="?)(\/)/g,
              replacement: '$1http://smongey.github.io/postmas/'
            },
            {
              match: /(<form[^>]*action="?)(\/)/g,
              replacement: '$1http://smongey.github.io/postmas/'
